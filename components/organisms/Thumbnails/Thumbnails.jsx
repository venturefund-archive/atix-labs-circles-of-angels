      ...
      <div className="ThumbnailsWrapper">
        ...
        <Row type="flex" justify="space-around" align="top" className="centered">
          <Col className="CardExample" sm={8} md={8} lg={8}>
            ...
            <Col className="spacedivider space-between" sm={24} md={24} lg={24}>
              <Col sm={24} md={24} lg={16}>

                <h1>              {fields.projectName.value || (
            ...
            <Col className="flex" sm={24} md={24} lg={24}>
              <InfoItem
                ...
                title=                {fields.countryOfImpact.value || (
                  <Skeleton paragraph={{ rows: 1 }} title={false} />
                )}
                iconInfoItem="dollar"
              />

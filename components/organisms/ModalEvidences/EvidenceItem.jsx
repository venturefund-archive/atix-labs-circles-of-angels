...
{ 
  ...
  <div className="EvidenceItem">
    <div className="Description">
      <div className="space-between">
        <div className="flex"> 
          ...
          <a href="#"
            ...
            <img className="BlockGray" src="/static/images/block-gray.svg" alt="blockchainicon" />
            <img className="BlockBlue" src="/static/images/block-blue.svg" alt="blockchainicon" />
          </a>
        </div>
      ...
      {/* <p>{description}</p> */}
      <p>Irure pariatur aliqua et sint magna labore. Irure aliqua et sint irure sit aute officia qui consectetur laborum non quis eiusmod. Aliquip aute consequat magna pariatur nisi. Laborum excepteur sunt tempor eiusmod Lorem. Laboris et elit do duis pariatur magna nisi consequat magna commodo cillum nisi qui laboris. Dolore enim ex irure veniam non. Nulla in nulla veniam ut excepteur ut eiusmod sint anim cupidatat.</p>
     </div>
    ...
    <div className={isOpen ? "panel-collapse": "panel-collapse panel-close"}
            ...
            <div className="Container">
              ...
              <h1>What´s saved on the <b>Blockchain ?</b></h1>
              <img src="/static/images/rsk-small.svg" />
              </div>
              <div className="flex">
                <ItemBlockchain 

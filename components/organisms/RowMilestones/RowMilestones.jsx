...
const RowMilestones = () => (
  <Row className="WrapperTable" xs={{ span: 24}}
  sm={{ span: 24}}
  md={18}
  lg={{ span: 16}}>
    <Col className="gutter-row TableMilestones" xs={{ span: 24}}
                  sm={{ span: 24}}
                  md={18}
                  lg={{ span: 20}}>
      ...
      <Col className="gutter-row vertical" xs={{ span: 24}}
                  sm={{ span: 24}}
                  md={18}
                  lg={{ span: 3}}>
    ...
    <Col className="WrapperActions flex space-between" xs={{ span: 24}}
      sm={{ span: 24}}
      md={4}
      lg={{ span: 4}}   >
    ...
    <Col className="WrapperActivities" xs={{ span: 24}}
      sm={{ span: 24}}
      md={24}
      lg={{ span: 24}}   >
      <Collapse defaultActiveKey={['1']} onChange={callback}>
        <Panel header="Activities" key="1">
          <div className="SubWrapperActivities">
            <Col className="gutter-row TableActivities" xs={{ span: 24}}
      sm={{ span: 24}}
      md={22}
      lg={{ span: 22}}   >
              <Col className="gutter-row " xs={{ span: 24}}
      ...
      lg={{ span: 9}}>
            ...
            <Col className="WrapperActionsActivities" xs={{ span: 24}}
      sm={{ span: 24}}
      md={2}
      lg={{ span: 2}}>
